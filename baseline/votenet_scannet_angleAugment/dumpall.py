...
if FLAGS.dataset == 'sunrgbd':
    ...
    TEST_DATASET = ScannetDetectionDataset('all', num_points=NUM_POINT,
        augment=False,
...
def evaluate_one_epoch():
    ...
    for batch_idx, batch_data_label in enumerate(TEST_DATALOADER):
        ...
        MODEL.vis_results(end_points, DUMP_DIR, DATASET_CONFIG, TEST_DATASET.scan_names)
        # if batch_idx == 0:
        #     MODEL.vis_results(end_points, DUMP_DIR, DATASET_CONFIG)
