...
class VotingModule(nn.Module):
    ...
    def forward(self, seed_xyz, seed_features):
        ...
        return vote_xyz, vote_features, vote_xyz_support, vote_features_support, vote_xyz_support_center, vote_xyz_support_offset,  vote_xyz_bsupport, vote_features_bsupport, vote_xyz_bsupport_center, vote_xyz_bsupport_offset
