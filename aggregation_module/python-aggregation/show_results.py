...
def export_one_scan(scan_name):
    ...
    init_proposals = np.load(os.path.join(opt_path, scan_name+'_init.npy'))
    opt_proposals = np.load(os.path.join(opt_path, scan_name+'_opt.npy'))
